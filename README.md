# 📚 Lý Thuyết Điều Khiển & Robotics — Trang Web Tự Học Toàn Diện

🌐 **Trang Web Trực Tuyến:** [danhcon.github.io/Ly-Thuyet-Dieu-Khien](https://danhcon.github.io/Ly-Thuyet-Dieu-Khien/)

Kho tài liệu tự học toàn diện về **Lý thuyết Điều khiển Tối ưu**, **LQR**, **Kalman Filter**, **Cảm biến IMU**, **Toán Nền tảng** và **C++ Hiện đại trong Control / Xe tự lái**. Tất cả tài liệu được trình bày bằng Tiếng Việt, hỗ trợ công thức LaTeX (MathJax), code Python / C++ mô phỏng và hướng dẫn thực chiến trên phần cứng thật.
...
1. **Xem trực tuyến (Khuyên dùng)**: Bấm vào bất kỳ link 🌐 **[Xem trang web]** ở bảng trên để mở trực tiếp trên trình duyệt của máy tính hay điện thoại mà không cần tải về.
2. **Xem trực tiếp trên máy tính**: Nhấp đôi vào bất kỳ file `.html` nào trong thư mục trên máy tính của bạn để mở offline.

---
*Kho tài liệu được biên soạn và cập nhật liên tục cho mục đích tự học & nghiên cứu Robotics, Control & Autonomous Systems.*
